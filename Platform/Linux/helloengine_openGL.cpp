//
// Created by lhospital on 18-6-2.
// 使用openGL来创建一个矩形
...
# include <X11/Xlib.h>      // 增加一些包
# include <X11/Xlib-xcb.h>
# include <xcb/xcb.h>

# include <GL/gl.h>         // 增加GL包
# include <GL/glx.h>
# include <GL/glu.h>
...
static bool isExtensionSupported(const char * extList, const char * extension)
{
    ...
    /*It takse a bit of care to be fool-proof about parsing the
     * OpenGL extendions string. Don't be fooled by sub-strings, etc.
     * */
    for (start = extList; ; )
    {
...
void DrawAQuad()
{
    ...
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);     // "|"是位运算符，按位异或
...
int main(void)  // 可以这样吗？？？ 可以
{
    ...
    int (* oldHandler)(Display *, XErrorEvent *) =
            XSetErrorHandler(&ctxErrorHandler);     // TODO: What the point of function?
